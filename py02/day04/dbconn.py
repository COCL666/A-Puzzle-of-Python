...
# [root@zl2 nsd2019]# pip3 install sqlalchemy
# MariaDB [(none)]> create database tedu1909 default charset utf8;
...
engine = create_engine(
    # myql_pymysql://用户名:密码@服务器/数据库?选项
...
class Employee(Base):
    ...
    emp_id = Column(Integer, primary_key=True)  # autoincrement=True 默认自增长
